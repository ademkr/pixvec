        ...
        <AnimatePresence mode="wait">
          ...
          {!uploadedFile && (
            <motion.div
              ...
              className="flex flex-col items-center gap-8 sm:gap-12 lg:flex-row lg:gap-16"
            >
              {/* Left: copy */}
                ...
                >
                  ...
                  <div className="flex flex-wrap justify-center gap-1.5">
                    {["PNG", "JPG", "WEBP", "BMP", "GIF"].map((fmt) => (
                      <span key={fmt} className="rounded-md bg-muted px-2 py-0.5 text-xs font-medium text-muted-foreground">
                        {fmt}
                      </span>
                    ))}
                  </div>
